...
echo ""
echo "The API also requires an OAuth bearer token from https://localhost:8443/auth/oauth/v2/token."
echo "If you want the local dev CA trusted automatically on macOS, run: ./certs/trust-local-ca.sh"
...
echo "       https://localhost:8443/mesh/imp1/NationalStudentClearinghouseService \\"
echo "       -H 'messageID: anything-seems-to-work-here' \\"
echo "       --json '{\"nscRequest\": {\"personGivenName\": \"Casey\", \"personSurName\": \"Bennett\"}}'"